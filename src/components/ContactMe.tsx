    ...
    <div className=" w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input overflow-auto bg-white dark:bg-black">
      ...
      <form className="my-8 sm:flex justify-center" onSubmit={onEmail}>
        ...
        <LabelInputContainer className="h-56">
            ...
            <textarea id="message" placeholder="Your message..."  className="h-40 md:max-w-xl px-4 py-2 whitespace-normal text-white bg-zinc-800 break-words resize-y"
            value={user.message}
        ...
        <Link href="mailto:thunderwolf.dev@gmail.com?subject=Hello%20there">
          <div
